...
export default function Header() {
  ...
  return (
    <header
      className="fixed bg-accent text-white font-bold z-100 w-full"
      data-aos="slide-down"
    >
      ...
      {isCartOpen && (
        <>
          ...
          />
          <aside
            className="fixed right-0 top-0 z-50 flex h-full w-full max-w-md flex-col bg-white text-black shadow-2xl"
            data-aos="slide-left"
          >
            ...
            <footer className="border-t px-6 py-4">
              ...
              <div className="mt-3 flex gap-3">
                <button
                  onClick={clearCart}
                  className="w-1/3 rounded-md border border-gray-300 px-3 py-2 text-xs font-semibold uppercase tracking-widest text-gray-600 transition hover:bg-gray-50"
                >
                  Clear All
                </button>
                <button className="flex-1 rounded-md bg-black px-4 py-2 text-sm font-semibold uppercase tracking-wide text-white transition hover:bg-gray-900">
                  Checkout
                </button>
              </div>
            </footer>
