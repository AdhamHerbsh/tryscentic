...
const faqData = [
  {
    title: "How to Redeem",
    content:
      "To redeem your gift card, simply enter the unique code at checkout. The gift card amount will be automatically deducted from your total purchase. Enjoy your new signature scent!",
