        ...
        <section className="relative w-full h-[550px] flex items-center justify-center overflow-hidden">
          ...
          <section className="absolute inset-0 flex flex-col justify-end items-start px-12 pb-12 z-10">
            <div className="mb-6">
              {/* Logo */}
              <Image
                src="/assets/images/logo/logo-icon-1200x1200.png" // حطي هنا مسار اللوجو
                alt="Logo"
                width={200} // حجم اللوجو
                height={300}
              />
            </div>
...
We work closely with trusted international brands and authentic suppliers to ensure every bottle you receive is 100% original. Whether you’re drawn to classic notes, modern blends, or rare niche perfumes, our mission is to help you find a scent that truly represents you.
