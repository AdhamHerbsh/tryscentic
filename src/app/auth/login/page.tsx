          ...
          <div className="p-5">
            <div className="flex items-center justify-center p-4">
              ...
              <div className="">
                {/* Logo */}
                <div className="mb-8">
                  <h1 className="text-5xl font-serif font-bold tracking-wider text-transparent bg-clip-text bg-gradient-to-b from-white to-amber-800 sm:text-6xl md:text-7xl">
                    TRYSCENTIC
                  </h1>
                </div>
                {/* Login Card */}
                <div className="rounded-3xl border-2 border-gray-300  p-8 shadow-2xl">
                  ...
                  <Link
                    href="../../"
                    className="block mb-3 rounded-lg bg-black py-3 font-semibold text-white shadow-lg transition-all hover:bg-gray-900 hover:shadow-xl"
                  >
                    Login
                  </Link>
